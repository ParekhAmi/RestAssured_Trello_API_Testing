...
public class TC010_GET_CheckItemsCreated extends TestBase{
	
	@BeforeClass
	void verifyCheckItemsCreated() throws InterruptedException {
		logger.info("***********Started TC010_GET_CheckItemsCreated*************");
	...
	@AfterClass
	void teaarDown() {
		logger.info("***********FInished TC010_GET_CheckItemsCreated*************");
	}
}
